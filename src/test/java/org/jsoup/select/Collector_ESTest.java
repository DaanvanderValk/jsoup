...
public class Collector_ESTest extends Collector_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(399).when(element0).childNodeSize();
  ...
  public void test2()  throws Throwable  {
      ...
      Node node0 = mock(Node.class, new ViolatedAssumptionAnswer());
      doReturn((Node) null).when(node0).childNode(anyInt());
      doReturn(1).when(node0).childNodeSize();
      Element element0 = mock(Element.class, new ViolatedAssumptionAnswer());
      doReturn(1).when(element0).childNodeSize();
  ...
  public void test4()  throws Throwable  {
      ...
      doReturn(0).when(element0).childNodeSize();
      doReturn((Node) null).when(element0).nextSibling();
      Elements elements0 = Collector.collect(evaluator0, element0);
